...
\exercise
Suppose $m = 3$ in Example \ref{PD} and $D_x, D_y$ are the commuting partial differentiation operators on $\P\!_3\3\paren[\big]{\R2}$ from that example. Find a basis of $\P\!_3\3\paren[\big]{\R2}$ with respect to which both $D_x$ and $D_y$ have an upper-triangular matrix.
