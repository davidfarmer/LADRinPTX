...
\chapter{Finite-Dimensional Vector~Spaces} \label{fin-dimVS}  %\label{16}
...
\index{Halmos, Paul}\index{Institute for Advanced Study}
...
\exercise
Verify all assertions in Example \ref{ex_bases}.
